...
contextBridge.exposeInMainWorld('api', {
  ...
  store: {
    ...
    transactionCreate: (taskId, d, r) => ipcRenderer.invoke('store:transactionCreate', taskId, d, r),
    transactionUpdate: (taskId, d, id, p) => ipcRenderer.invoke('store:transactionUpdate', taskId, d, id, p),
    transactionBatchCreate: (taskId, d, rs) => ipcRenderer.invoke('store:transactionBatchCreate', taskId, d, rs),
    transactionSaveSettings: (taskId, p) => ipcRenderer.invoke('store:transactionSaveSettings', taskId, p),
    rollbackTask: (taskId) => ipcRenderer.invoke('store:rollbackTask', taskId),
    commitTask: (taskId) => ipcRenderer.invoke('store:commitTask', taskId),
